...
(function (window, document) {
   ...
   */
    function addWrappers(ownerDocument) {
        var node;
        var nodes = ownerDocument.getElementsByTagName('*');
        var index = nodes.length;
        var reElements = RegExp('^(?:' + getElements().join('|') + ')$', 'i');
        var result = [];
   ...
   */
    function createWrapper(element) {
        var node;
        var nodes = element.attributes;
        var index = nodes.length;
        var wrapper = element.ownerDocument.createElement(shivNamespace + ':' + element.nodeName);
   ...
   */
    function shivCssText(cssText) {
        ...
        var reElements = RegExp('(^|[\\s,>+~])(' + getElements().join('|') + ')(?=[[\\s,>+~#.:]|$)', 'gi');
        var replacement = '$1' + shivNamespace + '\\:$2';
   ...
   */
    function shivPrint(ownerDocument) {
        ...
        var wrappers;
        var data = getExpandoData(ownerDocument);
        var namespaces = ownerDocument.namespaces;
        var ownerWindow = ownerDocument.parentWindow;
        ...
        ownerWindow.attachEvent('onbeforeprint', function () {
            ...
            var length;
            var sheet;
            var collection = ownerDocument.styleSheets;
            var cssText = [];
            var index = collection.length;
            var sheets = Array(index);
