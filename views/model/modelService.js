...
(function (factory) {
    ...
    *
    */
    app.service('modelService', ['$http', 'baseService', function ($http, baseService) {
        ...
        return {
            ...
            getAllOnLineModelsByGroup: function (params) {
                return baseService.postHttpNoDialog('model/queryOnLineModelsByGroup', params);
            },
            ...
            exportSingleRule: function () {
                return 'custom/model/exportSingleRule';
            },

            /*批量导出*/
            exportMoreRule: function () {
                return 'custom/model/exportMoreRule';
            },
            ...
            /*导出规则*/
            exportRule: function () {
                return 'custom/model/exportRule';
            },
            ...
            exportPreviewModel: function () {
                return 'custom/model/exportPreviewModel';
            },
            exportExcleMore: function () {
                return 'custom/model/exportExcleMore';
            },
            exportExcleAll: function () {
                return 'custom/model/exportExcleAll';
            },
            // 是否禁用弹窗的维度
            ...
            /*判断是否为顺序模式的接口*/
            isOrderModel: function (params) {
                return $http.post('model/isOrderModel', params);
            }
        };
    }
    ]);
