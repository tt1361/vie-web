...
(function (factory) {
    ...
    app.directive('onlingAction', ['$timeout', '$q', 'modelService', function ($timeout, $q, modelService) {
        return {
            restrict: 'EA',
            replace: true,
            scope: {
                ...
                scope.onling = function () {
                    modelService.getModelStatus({
                        ...
                        .then(function (result) {
                            ...
                            scope.item.onlineProgress = result.value && result.value.onlineProgress ? result.value.onlineProgress : '0.0%';
                        ...
                        timer = $timeout(scope.onling, 30000);
                    });
                };
