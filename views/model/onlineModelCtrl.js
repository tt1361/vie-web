...
(function (factory) {
     ...
     *
     */
    app.controller('onlineModelCtrl', [
        '$scope',
        'ngDialog',
        '$timeout',
        '$document',
        ...
        // 'dimensionService',
        // 
        function ($scope, ngDialog, $timeout, $document, dialogService, modelService, $http, CONSTANT, $rootScope, dimensionService) {
            ...
            if ($scope.onlineType === 'add') {
                ...
                modelService.getModel($scope.$parent.model.modelId).then(function (result) {
                    // 转化模型数据
                ...
                modelService.getModel($scope.$parent.onlineModel.modelId).then(function (result) {
                    // 转化模型数据
                    $scope.modelFilterId = result.value.filterId;
                    $scope.a.id = $scope.modelFilterId;
                });
