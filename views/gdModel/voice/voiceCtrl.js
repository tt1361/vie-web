...
(function (factory) {
    ...
    app.controller('voiceListCtrl', [
        ...
        'gdModelService',
        'winHeightService',
        'dimensionService', function ($scope, $stateParams, ngDialog, $q, $rootScope, $timeout, gdModelService, winHeightService, dimensionService) {
            ...
            $scope.getTableData = function (params) {
                ...
                if ($scope.type === 'hotword') {
                    ...
                    return gdModelService.getTableDataCluster(params)
                        .then(function (result) {
                    ...
                    return gdModelService.getTableData(params)
                        .then(function (result) {
                            $scope.headColums = result.value ? result.value.columns : [];
                            $scope.callLists = result.value ? result.value.previewList.rows : [];
                            $scope.counts = result.value ? result.value.previewList.totalRows : 0;
