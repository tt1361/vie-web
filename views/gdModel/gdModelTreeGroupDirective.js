...
(function (factory) {
    ...
    app.directive('gdModelnewGroup', [
        'RecursionHelper',
        'gdModelService', function (RecursionHelper, gdModelService) {
            return {
                restrict: 'EA',
                replace: true,
                templateUrl: 'gdModel/gdModel-tree-group-directive.htm',
                scope: {
                    item: '=',
                    model: '=',
                    type: '@'
                ...
                compile: function (element) {
                    return RecursionHelper.compile(element, function (scope, $el, arrt, controller, transcludeFn) {
                        ...
                        // 如果groupId不存在
                        // if(!scope.groupId){
                        //     gdModelService.searchModelGroup({modelGroupName: ''})
