...
(function (factory) {
    ...
    app.directive('silentScreen', [
        ...
        '$document',
        'dialogService',
        'gdModelService', function ($http, $timeout, $document, dialogService, gdModelService) {
            return {
                restrict: 'EA',
                replace: true,
                ...
                link: function ($scope, element, attrs) {
                    ...
                    $scope.selectTagDimension = function (item, num) {
                        ...
                        gdModelService.getTagProperty({dimensionId: item.dimensionId, dimensionCode: item.dimensionCode})
