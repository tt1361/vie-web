...
(function (factory) {
    ...
    app.directive('calendarGdModel', ['$document', '$rootScope', 'dialogService', function ($document, $rootScope, dialogService) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'gdModel/addNew/calendar-model-directive.htm',
            scope: {
                item: '=',
                status: '@',
                type: '@'
