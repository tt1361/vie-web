...
(function (factory) {
     ...
     */
    app.directive('znzsImple', ['$timeout', '$document', 'baseService', 'gdModelService', function ($timeout, $document, baseService, gdModelService) {
        return {
            restrict: 'EA',
            replace: true,
            ...
            link: function ($scope, element, attrs) {
                ...
                */
                ...
                $scope.searchZnzs = function () {
                    ...
                    gdModelService.associationImple({
                        word: $scope.word
                    })
                        .then(function () {
