...
(function (factory) {
    ...
    app.directive('gdModelOnlineScreenCondition', ['$document', '$q', 'dialogService', 'CONSTANT', function ($document, $q, dialogService, CONSTANT) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'gdModel/addNew/online-screen-condition.htm',
            scope: {
                item: '=',
                index: '@',
                type: '@'
